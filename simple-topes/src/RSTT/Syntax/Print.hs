...
instance Print RSTT.Syntax.Abs.Decl where
  prt i = \case
    ...
    RSTT.Syntax.Abs.DeclCommandRenderLatex shape -> prPrec i 0 (concatD [doc (showString "render"), doc (showString "latex"), prt 0 shape])
...
instance Print RSTT.Syntax.Abs.RuleName where
  prt i = \case
    RSTT.Syntax.Abs.RuleName str -> prPrec i 0 (concatD [printString str])
